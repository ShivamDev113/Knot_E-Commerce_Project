...
const PlaceOrder = () => {
  ...
  const {navigate , backendURL ,token , cart , setcart, getCartAmount , delivery_fee , products}=useContext(ShopContext)

  const [method, setmethod] = useState('cod')

  //stateManagement for Placing_Order--->Creating a objects for setting up a name , value in the form/.
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex justify-between gap-4 sm:flex-row pt-5 sm:pt-14 min-h-[80vh] border-t flex-col'>
      ...
      <input onChange={onChangeHandler} name='phone' value={formData.phone} className="border border-gray-300 rounded py-1 5 px-3.5 w-full" type="number" pattern="\d{10}" maxLength="10"  placeholder='Phone' required/>
      </div>
